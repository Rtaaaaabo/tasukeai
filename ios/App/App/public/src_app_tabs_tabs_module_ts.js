...
const routes = [
    {
        ...
        children: [
            {
                path: 'tab-home',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_tab-home_tab-home_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../tab-home/tab-home.module */ 70082)).then(m => m.TabHomePageModule)
            },
            {
                path: 'tab-chat',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_tab-chat_tab-chat_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../tab-chat/tab-chat.module */ 83811)).then(m => m.TabChatPageModule)
            },
            {
                path: 'tab3',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_tab3_tab3_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../tab3/tab3.module */ 20573)).then(m => m.Tab3PageModule)
            },
            {
                path: '',
